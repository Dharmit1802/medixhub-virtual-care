  ...
  const features = [
    {
      ...
      description:
        "Intelligent calendar-based booking system for patients and doctors with easy rescheduling.",
      icon: <CalendarCheck className="h-6 w-6" />,
    },
    {
      title: "AI-Powered Staff Scheduling",
      description:
        "Smart shift recommendations for hospital staff using machine learning predictions.",
      icon: <Clock className="h-6 w-6" />,
    },
    {
      title: "Emergency Room Analytics",
      description:
        "Real-time displays of predicted patient load in the emergency room based on AI analysis.",
      icon: <Users className="h-6 w-6" />,
    },
    {
      title: "Secure Billing Process",
      description:
        "Secure bill generation and fraud detection using advanced AI technologies.",
      icon: <Shield className="h-6 w-6" />,
    },
    {
      title: "AI Doctor Assistant",
      description:
        "Intelligent chatbot for patient queries and virtual consultations.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-medical-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <header className="relative overflow-hidden">
        ...
        <nav className="relative z-10 container mx-auto px-6 py-6 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-2xl font-bold">
              Medix<span className="text-medical-500">CARE</span>
            </span>
          </div>
          <div className="hidden md:flex items-center space-x-8">
            <a
              href="#features"
              className="text-sm font-medium hover:text-medical-500 transition-colors"
            >
              Features
            </a>
            <a
        ...
        <div className="relative z-10 container mx-auto px-6 pt-16 pb-24 md:pt-24 md:pb-32 text-center">
          ...
          >
            Streamline your hospital operations with our intelligent platform
            designed for doctors, patients, and staff. Experience the future of
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Our intelligent platform offers a comprehensive set of tools to
              revolutionize your hospital management workflow.
            </motion.p>
          </div>
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`p-3 rounded-lg bg-medical-100 text-medical-500 w-fit mb-4 transition-all duration-300 ${
                    isHovering === index
                      ? "bg-medical-500 text-white animate-pulse-glow"
                      : ""
                  }`}
                >
                  {feature.icon}
      ...
      <section
        id="benefits"
        className="py-16 md:py-24 bg-gradient-to-br from-medical-50 to-white dark:from-gray-800 dark:to-gray-900"
      >
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8">
                MedixCARE helps hospitals and healthcare providers improve
                patient care, reduce administrative burden, and optimize
                operations with intelligent automation and AI-powered insights.
              </p>
      ...
      <section className="py-16 md:py-24 bg-medical-500 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            MedixCARE to streamline their operations and improve patient care.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="flex flex-col md:flex-row justify-between gap-8">
            <div className="md:w-1/3">
              ...
              <p className="text-muted-foreground mb-6">
                Transforming healthcare management with the power of AI and
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <a
                      href="#"
                      className="text-muted-foreground hover:text-medical-500 transition-colors"
                    >
                      Features
                    </a>
                  </li>
