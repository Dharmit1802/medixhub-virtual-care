...
import { User, Search, UserPlus, Phone, Mail, CalendarDays, Activity, Clock } from "lucide-react";
...
export default function Patients({ userRole = 'doctor' }: PatientsProps) {
  // Sample patient data
                ...
                <CardTitle className="flex items-center gap-2">
                  ...
                  <div className="truncate">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-muted-foreground font-normal">{patient.id}</span>
                    </div>
